...
function checkResult(score){
    ...
    if(score<=63){
        ...
        $("#resultText").html("<p>您對性健康問題略知一二 / 性行為習慣仍存在風險，了解更多可<a href=#>按此</a>。青鳥建議每次性行為都應使用安全套，如曾發生過不安全性行為，應儘快安排進行性病 / 愛滋病快速測試。如你有多位性伴侶，不論有沒有使用安全套，亦應每三個月進行定期檢查，以確保健康。</p><p>如你是女性性工作者，也可預約到青鳥到訪中心進行愛滋病 / 梅毒病毒測試，費用全免亦不需要真名登記，<a href=#>詳情按此</a>。</p>");
    }else if(score>=92){
        risk = 3;
        $("#riskLevel").html("高");
        $("#riskLevel").addClass("high");
        $("#resultText").html("<p>您對性健康知識不足 / 性行為風險極高，需要多多了解。青鳥建議每次性行為都應使用安全套，如曾發生過不安全性行為，應儘快安排進行性病 / 愛滋病快速測試。如你有多位性伴侶，不論有沒有使用安全套，亦應每三個月進行定期檢查，以確保健康。</p><p>如你是女性性工作者，也可預約到青鳥到訪中心進行愛滋病 / 梅毒病毒測試，費用全免亦不需要真名登記，<a href=#>詳情按此</a>。</p>");
    }
